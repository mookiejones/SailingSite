...
import android.com.solutions.nerd.sailingsite.Consts;
import android.com.solutions.nerd.sailingsite.R;


import android.com.solutions.nerd.sailingsite.ui.widget.NavigationDrawerFragment;
import android.com.solutions.nerd.sailingsite.util.AccountUtils;
import android.com.solutions.nerd.sailingsite.util.AnalyticsManager;
import android.com.solutions.nerd.sailingsite.util.LoginAndAuthHelper;
import android.com.solutions.nerd.sailingsite.util.MarinasUtil;
import android.com.solutions.nerd.sailingsite.util.PlayServicesUtils;
...
public class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseRef = new Firebase(Consts.FIREBASE_URL);
        PrefUtils.init(this);
...
//        getContentResolver().notifyChange(ScheduleContract.MySchedule.CONTENT_URI, null, false);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Context context){
            ...
            final int arg=getArguments().getInt(ARG_SECTION_NUMBER);
            ((MainActivity) context).onSectionAttached(arg);
        }
    }
