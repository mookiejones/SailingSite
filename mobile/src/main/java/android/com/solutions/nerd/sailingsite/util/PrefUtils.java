...
public class PrefUtils {
    ...
    public static void init(final Context context) {
        ...
        if (conferenceYear != Config.CONFERENCE_YEAR) {
            ...
            sp.edit().clear().putInt(PREF_CONFERENCE_YEAR, Config.CONFERENCE_YEAR).apply();
        }
    }
    ...
    public static void markGotUserID(final Context context,boolean value){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        sp.edit().putBoolean(PREF_GOT_USER_ID,value).apply();
    }
    ...
    public static void markTosAccepted(final Context context) {
        try {
            ...
            editor.putBoolean(PREF_TOS_ACCEPTED, true).apply();
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public static void markAnsweredLocalOrRemote(final Context context) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        sp.edit().putBoolean(PREF_ANSWERED_LOCAL_OR_REMOTE, true).apply();
    }
