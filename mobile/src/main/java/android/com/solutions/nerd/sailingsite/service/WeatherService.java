package android.com.solutions.nerd.sailingsite.service;


import android.Manifest;
import android.com.solutions.nerd.sailingsite.Consts;
import android.com.solutions.nerd.sailingsite.WeatherWatchFaceConfigActivity;
...
public class WeatherService extends WearableListenerService
    ...
    public void onConnected(Bundle bundle) {
        ...
        requestLocationUpdates(CONSTANT);
    ...
    private void getWeather() {
        try {
            ...
            final Location current = getLastLocation();
            if (current==null)
                return;
            WeatherTask wt = new WeatherTask();
