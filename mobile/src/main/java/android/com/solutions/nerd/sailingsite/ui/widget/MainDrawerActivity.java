...
public class MainDrawerActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.app.Fragment f = getFragmentManager().findFragmentById((R.id.navigation_drawer));
...
/*        fragmentManager.beginTransaction()
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Context context){
            ...
            ((MainDrawerActivity)context).onSectionAttached(getArguments().getInt(ARG_SECTION_NUMBER));
        }
